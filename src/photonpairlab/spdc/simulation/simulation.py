...
This module provides :class:`~photonpairlab.spdc.simulation.simulation.SPDC_Simulation`, which computes
...
from photonpairlab.spdc.simulation.config import SPDCGridConfig, SPDCCenterConfig, SPDCRunConfig, build_wavelength_axes
...
class SPDC_Simulation:
    ...
    wavelength_idler_range : Sequence[float], optional
        ...
        If both values are ``None``, the range is taken from ``grid``.
        Prefer using ``grid``.
    grid : photonpairlab.spdc.simulation.config.SPDCGridConfig, optional
        Wavelength grid configuration. If ``None``, uses the default
        :class:`~photonpairlab.spdc.simulation.config.SPDCGridConfig`.
    ...
    grid : photonpairlab.spdc.simulation.config.SPDCGridConfig
    ...
    See Also
    --------
    photonpairlab.spdc.simulation.config.SPDCGridConfig
        Grid configuration (steps, dev_nm, and/or explicit wavelength ranges).
    photonpairlab.spdc.simulation.results.SPDCResults
    ...
    def run(self) -> SPDCResults:
        ...
        This method:
        1. Builds wavelength axes from :attr:`grid` (via :func:`~photonpairlab.spdc.simulation.config.build_wavelength_axes`).
        ...
        5. Returns an :class:`~photonpairlab.spdc.simulation.results.SPDCResults` instance.
